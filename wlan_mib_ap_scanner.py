...
def print_help():
    ...
    print(SP + "-v | --verbose          " + "[NOT IMPLEMENTED]print this help")
    ...
    print(SP + "-f | --file             " + "[stdout NOT IMPLEMENTED] Output file, use - for stdout, default /tmp/wlc_aps")
    print(SP + "-o | --objects          " + "[NOT IMPLEMENTED]print objects of table, default is print all, use numbers for each column")
    print("\n")
    print("EXAMPLE:")
